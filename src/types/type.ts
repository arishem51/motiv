export const SIGN_IN_SUCCESS = "Đăng nhập thành công";
export const SIGN_IN_ERROR = "Đăng nhập thành công";
export const CREATE_USER_SUCCESS = "Tạo tài khoản thành công";
